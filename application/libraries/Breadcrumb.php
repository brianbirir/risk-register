...
class Breadcrumb
{
  ...
  public function __construct()
  {
    ...
    $this->_container_open = $CI->config->item('container_open', 'breadcrumb');
    $this->_container_close = $CI->config->item('container_close', 'breadcrumb');
    $this->_divider = $CI->config->item('divider', 'breadcrumb');
