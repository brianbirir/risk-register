            ...
            <div class="box-body">
                ...
                <?php
                        if($register_users)
                        {
                            ...
                            {           
                                echo "<li class='list-group-item'>".$user->first_name." ".$user->last_name."<a class='btn btn-default btn-xs pull-right delete-action' data-title='Remove from this register?' data-toggle='confirmation' href='/settings/user/unassign/".$user->user_id."'>Unassign</a></li>";
                            }
                            echo "</ul>";
                        }
                        else
