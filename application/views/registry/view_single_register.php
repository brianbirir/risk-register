                                    ...
                                    <?php
                                        foreach ($risk_data as $risk_row) 
                                        {
                                            ...
                                            echo "<td>
                                                ...
                                                <span><a onclick='archive_confirmation()' class='delete-action' title='archive' href='/dashboard/risk/archive/".$risk_row->item_id."'><i class='fa fa-trash' aria-hidden='true'></i></a></span>
                                                    </td>";
                                            echo "</tr>";
                                        } 
                                ?>
