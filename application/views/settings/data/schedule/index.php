...
<div class="row">
    <div class="col-md-12">
        <div class="reg-btn">
            <a href="/settings/data/schedule/add" class="btn btn-success btn-sm">Add Risk Schedule</a>
        </div>
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            foreach ($schedule_data as $schedule_row) 
                            {
                                ...
                                echo "<td>
                                        <a title='edit' href='/settings/data/schedule/edit/".$schedule_row->schedule_id."'><i class='fa fa-pencil' aria-hidden='true'></i>
                                        <a title='delete' href='/settings/data/schedule/delete/".$schedule_row->schedule_id."'><i class='fa fa-trash' aria-hidden='true'></i>
                                    </td>";
                                echo "</tr>";
                            } 
                        } ?>
