<div class="row">
    <div class="col-md-4">
        <div class="list-group">
            <a href="/settings/data/status" class="list-group-item">Status</a>
            <a href="/settings/data/risk_category" class="list-group-item">Risk Categories</a>
            <a href="/settings/data/system_safety" class="list-group-item">System Safety</a>
            <a href="/settings/data/risk_strategy" class="list-group-item">Risk Strategies</a>
            <a href="/settings/data/risk_owner" class="list-group-item">Risk Owners</a>
