<head>
	...
	<!-- <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/skins/skin-aldea.css"> -->
	<!-- Vendor CSS -->
	<link rel = "stylesheet" type = "text/css" href = "<?php echo base_url(); ?>assets/vendor/jquery-ui/themes/ui-lightness/jquery-ui.min.css">
	<link rel = "stylesheet" type = "text/css" href = "<?php echo base_url(); ?>assets/vendor/iCheck/all.css">
	<!-- Custom CSS -->
