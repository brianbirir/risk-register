    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $revision_data->risk_title; ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $revision_data->effective_date; ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $revision_data->reference_number; ?></span>
            </div>
        </div>
    </div>
</div>
...
<div class="box box-success">
  ...
  <div class="box-body">
        <?php
            ...
            echo "<td><p>".$revision_data->materialization_phase_materialization_id."</p></td>";
            echo "</tr>";
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="box box-info">
            ...
            <?php
                ...
                echo "<td><p>".$revision_data->likelihood."</p></td>";
                echo "</tr>";
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="box box-info">
            ...
            <?php
                ...
                echo "<tr>";
                echo "<td><label>Likelihood:</label></td>";
                echo "<td><p>".$revision_data->likelihood_current."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Time Impact:</label>";
                echo "<td><p>".$revision_data->time_impact_current."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Cost Impact:</label>";
                echo "<td><p>".$revision_data->cost_impact_current."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Reputation Impact:</label></td>";
                echo "<td><p>".$revision_data->reputation_impact_current."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>H & S Impact:</label></td>";
                echo "<td><p>".$revision_data->hs_impact_current."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Environment Impact:</label></td>";
                echo "<td><p>".$revision_data->env_impact_current."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Legal Impact:</label></td>";
                echo "<td><p>".$revision_data->legal_impact_current."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Quality Impact:</label></td>";
                echo "<td><p>".$revision_data->quality_impact_current."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Risk Rating:</label></td>";
                echo "<td><p>".$revision_data->risk_rating_current."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Risk Level:</label></td>";
                echo "<td><p>".$revision_data->risk_level_current."</p></td>";
                echo "</tr>";
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="box box-info">
            ...
            <?php
                ...
                echo "<tr>";
                echo "<td><label>Likelihood:</label></td>";
                echo "<td><p>".$revision_data->likelihood_target."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Time Impact:</label>";
                echo "<td><p>".$revision_data->time_impact_target."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Cost Impact:</label>";
                echo "<td><p>".$revision_data->cost_impact_target."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Reputation Impact:</label></td>";
                echo "<td><p>".$revision_data->reputation_impact_target."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>H & S Impact:</label></td>";
                echo "<td><p>".$revision_data->hs_impact_target."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Environment Impact:</label></td>";
                echo "<td><p>".$revision_data->env_impact_target."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Legal Impact:</label></td>";
                echo "<td><p>".$revision_data->legal_impact_target."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Quality Impact:</label></td>";
                echo "<td><p>".$revision_data->quality_impact_target."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Risk Rating:</label></td>";
                echo "<td><p>".$revision_data->risk_rating_target."</p></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td><label>Risk Level:</label></td>";
                echo "<td><p>".$revision_data->risk_level_target."</p></td>";
                echo "</tr>";
...
<div class="row">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <?php
            ...
            echo "<td><p>".$CI->user_model->getUserNames($revision_data->action_owner)."</p></td>";
            echo "</tr>";

            echo "<tr>";
            echo "<td><label>Action Item:</label>";
            echo "<td><p>".$revision_data->action_item."</p></td>";
            echo "</tr>";
