    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div id="reg-subproject-form">
            ...
            <?php
                ...
                echo form_open("risk/duplicate_risk", $attributes);
            ?>
            ...
            <div class="form-group">
                <label for="roles">Select Register to Duplicate</label>
                <?php
                    $select_attributes = 'class="form-control"';
                    echo form_dropdown('project',$select_register_option,"1",$select_attributes);
                ?>
            </div>

            <input name="btn_reg_subproject" type="submit" class="btn btn-default btn-reg" value="Next" />
