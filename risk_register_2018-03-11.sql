...
# Generation Time: 2018-03-11 20:18:56 +0000
# ************************************************************
...
# Dump of table CostMetric
# ------------------------------------------------------------

DROP TABLE IF EXISTS `CostMetric`;
...
CREATE TABLE `CostMetric` (
  ...
  KEY `fk_CostMetric_Project1_idx` (`Project_project_id`),
  CONSTRAINT `fk_CostMetric_Project1` FOREIGN KEY (`Project_project_id`) REFERENCES `Project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `CostMetric` WRITE;
/*!40000 ALTER TABLE `CostMetric` DISABLE KEYS */;

INSERT INTO `CostMetric` (`cost_id`, `cost_rating`, `created_at`, `updated_at`, `cost_description`, `Project_project_id`)
VALUES
...
/*!40000 ALTER TABLE `CostMetric` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table CurrentRiskLevels
# ------------------------------------------------------------

DROP TABLE IF EXISTS `CurrentRiskLevels`;
...
CREATE TABLE `CurrentRiskLevels` (
  ...
  KEY `fk_PreRiskLevels_CostMetric1_idx` (`CostMetric_cost_id`),
  KEY `fk_PreRiskLevels_ScheduleMetric1_idx` (`ScheduleMetric_schedule_id`),
  CONSTRAINT `fk_PreRiskLevels_CostMetric11` FOREIGN KEY (`CostMetric_cost_id`) REFERENCES `CostMetric` (`cost_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_PreRiskLevels_ScheduleMetric11` FOREIGN KEY (`ScheduleMetric_schedule_id`) REFERENCES `ScheduleMetric` (`schedule_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `Entity` (
  ...
  KEY `fk_Entity_Project1_idx` (`Project_project_id`),
  CONSTRAINT `fk_Entity_Project1` FOREIGN KEY (`Project_project_id`) REFERENCES `Project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `Entity` WRITE;
/*!40000 ALTER TABLE `Entity` DISABLE KEYS */;

INSERT INTO `Entity` (`entity_id`, `entity_name`, `created_at`, `updated_at`, `Project_project_id`)
VALUES
	(1,'Owner',NULL,NULL,0),
...
CREATE TABLE `Hazards` (
  ...
  UNIQUE KEY `hazard_id_UNIQUE` (`hazard_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table MaterializationPhase
# ------------------------------------------------------------

DROP TABLE IF EXISTS `MaterializationPhase`;

CREATE TABLE `MaterializationPhase` (
  `materialization_id` int(11) NOT NULL AUTO_INCREMENT,
  `materialization_name` varchar(45) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `Project_project_id` int(11) NOT NULL,
  PRIMARY KEY (`materialization_id`),
  UNIQUE KEY `materialization_id_UNIQUE` (`materialization_id`),
  KEY `fk_MaterializationPhase_Project1_idx` (`Project_project_id`),
  CONSTRAINT `fk_MaterializationPhase_Project1` FOREIGN KEY (`Project_project_id`) REFERENCES `Project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `MaterializationPhase` WRITE;
/*!40000 ALTER TABLE `MaterializationPhase` DISABLE KEYS */;

INSERT INTO `MaterializationPhase` (`materialization_id`, `materialization_name`, `created_at`, `updated_at`, `Project_project_id`)
VALUES
	(1,'Project Execution',NULL,NULL,7);

/*!40000 ALTER TABLE `MaterializationPhase` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table PreRiskLevels
# ------------------------------------------------------------

DROP TABLE IF EXISTS `PreRiskLevels`;
...
CREATE TABLE `PreRiskLevels` (
  ...
  KEY `fk_PreRiskLevels_CostMetric1_idx` (`CostMetric_cost_id`),
  KEY `fk_PreRiskLevels_ScheduleMetric1_idx` (`ScheduleMetric_schedule_id`),
  CONSTRAINT `fk_PreRiskLevels_CostMetric1` FOREIGN KEY (`CostMetric_cost_id`) REFERENCES `CostMetric` (`cost_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_PreRiskLevels_ScheduleMetric1` FOREIGN KEY (`ScheduleMetric_schedule_id`) REFERENCES `ScheduleMetric` (`schedule_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `Project` (
  ...
  CONSTRAINT `fk_Project_User1` FOREIGN KEY (`User_user_id`) REFERENCES `User` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `Project` WRITE;
/*!40000 ALTER TABLE `Project` DISABLE KEYS */;

INSERT INTO `Project` (`project_id`, `project_name`, `project_description`, `created_at`, `updated_at`, `User_user_id`)
VALUES
...
# Dump of table Realization
# ------------------------------------------------------------

DROP TABLE IF EXISTS `Realization`;

CREATE TABLE `Realization` (
  `realization_id` int(11) NOT NULL AUTO_INCREMENT,
  `realization_name` varchar(45) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `Project_project_id` int(11) NOT NULL,
  PRIMARY KEY (`realization_id`),
  UNIQUE KEY `realization_id_UNIQUE` (`realization_id`),
  KEY `fk_Realization_Project1_idx` (`Project_project_id`),
  CONSTRAINT `fk_Realization_Project1` FOREIGN KEY (`Project_project_id`) REFERENCES `Project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `Realization` WRITE;
/*!40000 ALTER TABLE `Realization` DISABLE KEYS */;

INSERT INTO `Realization` (`realization_id`, `realization_name`, `created_at`, `updated_at`, `Project_project_id`)
VALUES
	(1,'Yes',NULL,NULL,0),
	(2,'No',NULL,NULL,0),
	(3,'Yes',NULL,NULL,7),
...
# Dump of table RegisterCopy
# ------------------------------------------------------------

DROP TABLE IF EXISTS `RegisterCopy`;
...
CREATE TABLE `RegisterCopy` (
  ...
  KEY `fk_RegisterCopy_Subproject1_idx` (`Subproject_subproject_id`),
  CONSTRAINT `fk_RegisterCopy_Subproject1` FOREIGN KEY (`Subproject_subproject_id`) REFERENCES `Subproject` (`subproject_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `RegisterCopy` WRITE;
/*!40000 ALTER TABLE `RegisterCopy` DISABLE KEYS */;

INSERT INTO `RegisterCopy` (`copy_id`, `Subproject_subproject_id`, `original_id`)
VALUES
	(1,34,'33'),
	(2,35,'33'),
	(3,36,'33');

/*!40000 ALTER TABLE `RegisterCopy` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ResponseTitle
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ResponseTitle`;
...
CREATE TABLE `ResponseTitle` (
  ...
  UNIQUE KEY `status_id_UNIQUE` (`response_id`),
  KEY `fk_ResponseTitle_Project1_idx` (`Project_project_id`),
  CONSTRAINT `fk_ResponseTitle_Project1` FOREIGN KEY (`Project_project_id`) REFERENCES `Project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `ResponseTitle` WRITE;
/*!40000 ALTER TABLE `ResponseTitle` DISABLE KEYS */;

INSERT INTO `ResponseTitle` (`response_id`, `response_name`, `created_at`, `updated_at`, `Project_project_id`)
VALUES
	(1,'Electricity Harzard','2018-03-06 00:00:00','2018-03-06 00:00:00',7),
	(2,'Oil Spill','2018-03-06 00:00:00','2018-03-06 00:00:00',7);

/*!40000 ALTER TABLE `ResponseTitle` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table RiskCategories
# ------------------------------------------------------------
...
CREATE TABLE `RiskCategories` (
  ...
  KEY `fk_RiskCategories_Project1_idx` (`Project_project_id`),
  CONSTRAINT `fk_RiskCategories_Project1` FOREIGN KEY (`Project_project_id`) REFERENCES `Project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `RiskCategories` WRITE;
/*!40000 ALTER TABLE `RiskCategories` DISABLE KEYS */;

INSERT INTO `RiskCategories` (`category_id`, `category_name`, `created_at`, `updated_at`, `Project_project_id`)
VALUES
...
# Dump of table RiskOwner
# ------------------------------------------------------------

DROP TABLE IF EXISTS `RiskOwner`;

CREATE TABLE `RiskOwner` (
  `riskowner_id` int(11) NOT NULL AUTO_INCREMENT,
  `risk_owner` varchar(45) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `Project_project_id` int(11) NOT NULL,
  PRIMARY KEY (`riskowner_id`),
  UNIQUE KEY `riskowner_id_UNIQUE` (`riskowner_id`),
  KEY `fk_RiskOwner_Project1_idx` (`Project_project_id`),
  CONSTRAINT `fk_RiskOwner_Project1` FOREIGN KEY (`Project_project_id`) REFERENCES `Project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `RiskOwner` WRITE;
/*!40000 ALTER TABLE `RiskOwner` DISABLE KEYS */;

INSERT INTO `RiskOwner` (`riskowner_id`, `risk_owner`, `created_at`, `updated_at`, `Project_project_id`)
VALUES
	(1,'VTA',NULL,NULL,0),
...
/*!40000 ALTER TABLE `RiskOwner` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table RiskRegistry
# ------------------------------------------------------------

DROP TABLE IF EXISTS `RiskRegistry`;
...
CREATE TABLE `RiskRegistry` (
  ...
  KEY `fk_RiskRegistry_Status1_idx` (`Status_status_id`),
  KEY `fk_RiskRegistry_SystemSafety1_idx` (`SystemSafety_safety_id`),
  KEY `fk_RiskRegistry_RiskCategories1_idx` (`RiskCategories_category_id`),
  KEY `fk_RiskRegistry_Realization1_idx` (`Realization_realization_id`),
  KEY `fk_RiskRegistry_Subproject1_idx` (`Subproject_subproject_id`),
  KEY `fk_RiskRegistry_User1_idx` (`User_user_id`),
  KEY `fk_RiskRegistry_RiskOwner1_idx` (`RiskOwner_riskowner_id`),
  KEY `fk_RiskRegistry_Entity1_idx` (`Entity_entity_id`),
  KEY `fk_RiskRegistry_materialization_phase1_idx` (`materialization_phase_materialization_id`),
  KEY `fk_RiskRegistry_CostMetric1_idx` (`CostMetric_cost_id`),
  KEY `fk_RiskRegistry_ScheduleMetric1_idx` (`ScheduleMetric_schedule_id`),
  KEY `fk_RiskRegistry_RiskSubCategories1_idx` (`RiskSubCategories_subcategory_id`),
  CONSTRAINT `fk_RiskRegistry_CostMetric1` FOREIGN KEY (`CostMetric_cost_id`) REFERENCES `CostMetric` (`cost_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_Entity1` FOREIGN KEY (`Entity_entity_id`) REFERENCES `Entity` (`entity_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_Realization1` FOREIGN KEY (`Realization_realization_id`) REFERENCES `Realization` (`realization_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_RiskCategories1` FOREIGN KEY (`RiskCategories_category_id`) REFERENCES `RiskCategories` (`category_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_RiskOwner1` FOREIGN KEY (`RiskOwner_riskowner_id`) REFERENCES `RiskOwner` (`riskowner_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_RiskSubCategories1` FOREIGN KEY (`RiskSubCategories_subcategory_id`) REFERENCES `RiskSubCategories` (`subcategory_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_ScheduleMetric1` FOREIGN KEY (`ScheduleMetric_schedule_id`) REFERENCES `ScheduleMetric` (`schedule_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_Status1` FOREIGN KEY (`Status_status_id`) REFERENCES `Status` (`status_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_Subproject1` FOREIGN KEY (`Subproject_subproject_id`) REFERENCES `Subproject` (`subproject_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_SystemSafety1` FOREIGN KEY (`SystemSafety_safety_id`) REFERENCES `SystemSafety` (`safety_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_User1` FOREIGN KEY (`User_user_id`) REFERENCES `User` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_materialization_phase1` FOREIGN KEY (`materialization_phase_materialization_id`) REFERENCES `MaterializationPhase` (`materialization_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `RiskRegistry` WRITE;
/*!40000 ALTER TABLE `RiskRegistry` DISABLE KEYS */;

INSERT INTO `RiskRegistry` (`item_id`, `identified_hazard_risk`, `cause_trigger`, `materialization_phase`, `likelihood`, `time_impact`, `cost_impact`, `reputation_impact`, `hs_impact`, `env_impact`, `legal_impact`, `quality_impact`, `risk_rating`, `risk_level`, `control_mitigation`, `milestone_target_date`, `Status_status_id`, `SystemSafety_safety_id`, `RiskCategories_category_id`, `Realization_realization_id`, `Subproject_subproject_id`, `effect`, `effective_date`, `User_user_id`, `archived`, `archived_date`, `RiskOwner_riskowner_id`, `description_change`, `entity`, `risk_title`, `project_location`, `risk_uuid`, `duplicated`, `created_at`, `Entity_entity_id`, `materialization_phase_materialization_id`, `CostMetric_cost_id`, `ScheduleMetric_schedule_id`, `likelihood_current`, `reputation_impact_current`, `hs_impact_current`, `env_impact_current`, `legal_impact_current`, `quality_impact_current`, `risk_rating_current`, `risk_level_current`, `likelihood_target`, `reputation_impact_target`, `hs_impact_target`, `env_impact_target`, `legal_impact_target`, `quality_impact_target`, `risk_rating_target`, `risk_level_target`, `time_impact_current`, `cost_impact_current`, `time_impact_target`, `cost_impact_target`, `action_owner`, `action_item`, `RiskSubCategories_subcategory_id`, `original_risk_id`)
VALUES
	...
	(272,'xxx','xxx',NULL,2,NULL,NULL,1,1,1,1,1,2,'Threat Low',NULL,'xxx',8,14,30,3,33,'xxx','2018-03-11',9,0,NULL,5,'xxxx',NULL,'xxx','xxxx','cd615716-2334-49c1-9858-facfdbd2a61b',NULL,'2018-03-11 00:00:00',6,1,1,1,1,1,1,1,4,1,4,'Threat Medium',1,1,1,1,1,5,5,'Threat Medium',1,1,1,1,12,'xxx',5,'30.5.271'),
	(273,'eee','eee',NULL,3,NULL,NULL,1,1,1,1,1,3,'Threat Low',NULL,'eeee',8,14,30,3,33,'eee','2018-03-11',9,0,NULL,5,'eeee',NULL,'eee','eee','83ec1cba-6c85-4a63-a4d4-d1cec6bd8174',NULL,'2018-03-11 00:00:00',6,1,1,1,1,1,1,1,4,1,4,'Threat Medium',3,1,1,1,1,1,3,'Threat Low',1,1,1,1,12,'eeee',5,'30.5.272'),
	(274,'rrrr','rrr',NULL,3,NULL,NULL,1,1,1,1,1,3,'Threat Low',NULL,'rrrr',8,14,30,3,33,'rrr','2018-03-11',9,0,NULL,5,'rrrr',NULL,'rrr','rrr','6542f38c-4986-4407-8cef-cb181f59287e',NULL,'2018-03-11 00:00:00',6,1,1,1,2,1,1,1,1,1,2,'Threat Low',1,1,1,1,5,1,5,'Threat Medium',1,1,1,1,12,'rrrr',6,'30.6.273');

/*!40000 ALTER TABLE `RiskRegistry` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table RiskResponse
# ------------------------------------------------------------

DROP TABLE IF EXISTS `RiskResponse`;
...
CREATE TABLE `RiskResponse` (
  ...
  PRIMARY KEY (`response_id`),
  UNIQUE KEY `responde_id_UNIQUE` (`response_id`),
  KEY `fk_RiskResponse_RiskStrategies1_idx` (`RiskStrategies_strategy_id`),
  KEY `fk_RiskResponse_ResponseTitle1_idx` (`ResponseTitle_id`),
  CONSTRAINT `fk_RiskResponse_ResponseTitle1` FOREIGN KEY (`ResponseTitle_id`) REFERENCES `ResponseTitle` (`response_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskResponse_RiskStrategies1` FOREIGN KEY (`RiskStrategies_strategy_id`) REFERENCES `RiskStrategies` (`strategy_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `RiskResponse` WRITE;
/*!40000 ALTER TABLE `RiskResponse` DISABLE KEYS */;

INSERT INTO `RiskResponse` (`response_id`, `risk_uuid`, `response_uuid`, `response_title`, `RiskStrategies_strategy_id`, `register_id`, `user_id`, `created_at`, `updated_at`, `due_date`, `ResponseTitle_id`)
VALUES
	...
	(10,'b4dee525-529b-4edd-92bc-c7e29220e82d','bbe2ae94-07ac-4b9c-a594-370d760b15bf','wwww',6,33,12,'2018-02-26','2018-02-26',NULL,0),
	(11,'cd615716-2334-49c1-9858-facfdbd2a61b','f36a6807-6505-40e7-9272-b4410337d32f',NULL,6,33,12,'2018-03-27','2018-03-27','2018-04-03',1),
	(12,'83ec1cba-6c85-4a63-a4d4-d1cec6bd8174','ba2189b1-8e4e-4fed-8799-67f78e5c6fb2',NULL,6,33,12,'2018-03-21','2018-03-21','2018-03-28',1),
	(13,'6542f38c-4986-4407-8cef-cb181f59287e','21a73507-565a-4b35-9d7f-657cffcf27a7',NULL,6,33,14,'2018-03-21','2018-03-21','2018-03-28',1);

/*!40000 ALTER TABLE `RiskResponse` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table RiskRevisions
# ------------------------------------------------------------

DROP TABLE IF EXISTS `RiskRevisions`;
...
CREATE TABLE `RiskRevisions` (
  ...
  UNIQUE KEY `item_id_UNIQUE` (`revision_id`),
  KEY `fk_RiskRegistry_Status1_idx` (`Status_status_id`),
  KEY `fk_RiskRegistry_SystemSafety1_idx` (`SystemSafety_safety_id`),
  KEY `fk_RiskRegistry_RiskCategories1_idx` (`RiskCategories_category_id`),
  KEY `fk_RiskRegistry_Realization1_idx` (`Realization_realization_id`),
  ...
  KEY `fk_RiskRegistry_User1_idx` (`User_user_id`),
  KEY `fk_RiskRegistry_RiskOwner1_idx` (`RiskOwner_riskowner_id`),
  KEY `fk_RiskRevisions_RiskRegistry1_idx` (`item_id`),
  KEY `fk_RiskRevisions_materialization_phase1_idx` (`materialization_phase_materialization_id`),
  KEY `fk_RiskRevisions_Entity1_idx` (`Entity_entity_id`),
  KEY `fk_RiskRevisions_CostMetric1_idx` (`CostMetric_cost_id`),
  KEY `fk_RiskRevisions_ScheduleMetric1_idx` (`ScheduleMetric_schedule_id`),
  CONSTRAINT `fk_RiskRegistry_Realization10` FOREIGN KEY (`Realization_realization_id`) REFERENCES `Realization` (`realization_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_RiskCategories10` FOREIGN KEY (`RiskCategories_category_id`) REFERENCES `RiskCategories` (`category_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_RiskOwner10` FOREIGN KEY (`RiskOwner_riskowner_id`) REFERENCES `RiskOwner` (`riskowner_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_Status10` FOREIGN KEY (`Status_status_id`) REFERENCES `Status` (`status_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_Subproject10` FOREIGN KEY (`Subproject_subproject_id`) REFERENCES `Subproject` (`subproject_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_SystemSafety10` FOREIGN KEY (`SystemSafety_safety_id`) REFERENCES `SystemSafety` (`safety_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRegistry_User10` FOREIGN KEY (`User_user_id`) REFERENCES `User` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRevisions_CostMetric1` FOREIGN KEY (`CostMetric_cost_id`) REFERENCES `CostMetric` (`cost_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRevisions_Entity1` FOREIGN KEY (`Entity_entity_id`) REFERENCES `Entity` (`entity_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRevisions_RiskRegistry1` FOREIGN KEY (`item_id`) REFERENCES `RiskRegistry` (`item_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRevisions_ScheduleMetric1` FOREIGN KEY (`ScheduleMetric_schedule_id`) REFERENCES `ScheduleMetric` (`schedule_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RiskRevisions_materialization_phase1` FOREIGN KEY (`materialization_phase_materialization_id`) REFERENCES `MaterializationPhase` (`materialization_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `RiskRevisions` WRITE;
/*!40000 ALTER TABLE `RiskRevisions` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `RiskRevisions` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table RiskStrategies
# ------------------------------------------------------------

DROP TABLE IF EXISTS `RiskStrategies`;
...
CREATE TABLE `RiskStrategies` (
  ...
  UNIQUE KEY `strategy_id_UNIQUE` (`strategy_id`),
  KEY `fk_RiskStrategies_Project1_idx` (`Project_project_id`),
  CONSTRAINT `fk_RiskStrategies_Project1` FOREIGN KEY (`Project_project_id`) REFERENCES `Project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `RiskStrategies` WRITE;
/*!40000 ALTER TABLE `RiskStrategies` DISABLE KEYS */;

INSERT INTO `RiskStrategies` (`strategy_id`, `strategy_name`, `Project_project_id`, `created_at`, `updated_at`)
VALUES
...
/*!40000 ALTER TABLE `RiskStrategies` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table RiskSubCategories
# ------------------------------------------------------------

DROP TABLE IF EXISTS `RiskSubCategories`;
...
CREATE TABLE `RiskSubCategories` (
  ...
  KEY `fk_RiskSubCategories_RiskCategories1_idx` (`RiskCategories_category_id`),
  CONSTRAINT `fk_RiskSubCategories_RiskCategories1` FOREIGN KEY (`RiskCategories_category_id`) REFERENCES `RiskCategories` (`category_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `RiskSubCategories` WRITE;
/*!40000 ALTER TABLE `RiskSubCategories` DISABLE KEYS */;

INSERT INTO `RiskSubCategories` (`subcategory_id`, `subcategory_name`, `created_at`, `updated_at`, `RiskCategories_category_id`)
VALUES
...
/*!40000 ALTER TABLE `RiskSubCategories` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `Role` (`role_id`, `role_name`, `role_description`, `created_at`, `updated_at`)
VALUES
	(1,'Super Administrator','Manages all other roles of the system',NULL,'2017-11-18 13:22:54'),
	(8,'General user','General user role','2017-11-16 18:01:46','2017-11-16 18:01:46'),
	(9,'Program Manager','Manages programs','2017-11-16 18:08:46','2017-11-16 18:08:46'),
	(10,'Project Manager','Project manager role','2017-11-18 14:10:23','2017-11-18 14:10:23');

/*!40000 ALTER TABLE `Role` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ScheduleMetric
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ScheduleMetric`;
...
CREATE TABLE `ScheduleMetric` (
  ...
  KEY `fk_ScheduleMetric_Project1_idx` (`Project_project_id`),
  CONSTRAINT `fk_ScheduleMetric_Project1` FOREIGN KEY (`Project_project_id`) REFERENCES `Project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `ScheduleMetric` WRITE;
/*!40000 ALTER TABLE `ScheduleMetric` DISABLE KEYS */;

INSERT INTO `ScheduleMetric` (`schedule_id`, `schedule_rating`, `created_at`, `updated_at`, `schedule_description`, `Project_project_id`)
VALUES
	(1,'1',NULL,NULL,'1 million dollars',0),
	(2,'2',NULL,NULL,'2 million dollars',0),
	(3,'3',NULL,NULL,'3 million dollars',0),
...
/*!40000 ALTER TABLE `ScheduleMetric` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `Status` (
  ...
  KEY `fk_Status_Project1_idx` (`Project_project_id`),
  CONSTRAINT `fk_Status_Project1` FOREIGN KEY (`Project_project_id`) REFERENCES `Project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `Status` WRITE;
/*!40000 ALTER TABLE `Status` DISABLE KEYS */;

INSERT INTO `Status` (`status_id`, `status_name`, `created_at`, `updated_at`, `Project_project_id`)
VALUES
...
CREATE TABLE `Subproject` (
  ...
  KEY `fk_Subproject_Project1_idx` (`Project_project_id`),
  CONSTRAINT `fk_Subproject_Project1` FOREIGN KEY (`Project_project_id`) REFERENCES `Project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `Subproject` WRITE;
/*!40000 ALTER TABLE `Subproject` DISABLE KEYS */;

INSERT INTO `Subproject` (`subproject_id`, `name`, `description`, `created_at`, `updated_at`, `Project_project_id`, `duplicate`)
VALUES
...
# Dump of table Subproject_has_User
# ------------------------------------------------------------

DROP TABLE IF EXISTS `Subproject_has_User`;

CREATE TABLE `Subproject_has_User` (
  `Subproject_subproject_id` int(11) NOT NULL,
  `User_user_id` int(11) NOT NULL,
  PRIMARY KEY (`Subproject_subproject_id`,`User_user_id`),
  KEY `fk_Subproject_has_User_User1_idx` (`User_user_id`),
  KEY `fk_Subproject_has_User_Subproject1_idx` (`Subproject_subproject_id`),
  CONSTRAINT `fk_Subproject_has_User_Subproject1` FOREIGN KEY (`Subproject_subproject_id`) REFERENCES `Subproject` (`subproject_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Subproject_has_User_User1` FOREIGN KEY (`User_user_id`) REFERENCES `User` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `Subproject_has_User` WRITE;
/*!40000 ALTER TABLE `Subproject_has_User` DISABLE KEYS */;

INSERT INTO `Subproject_has_User` (`Subproject_subproject_id`, `User_user_id`)
VALUES
	(33,12),
	(33,13),
	(33,14),
...
/*!40000 ALTER TABLE `Subproject_has_User` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table SystemSafety
# ------------------------------------------------------------

DROP TABLE IF EXISTS `SystemSafety`;
...
CREATE TABLE `SystemSafety` (
  ...
  UNIQUE KEY `safety_id_UNIQUE` (`safety_id`),
  KEY `fk_SystemSafety_Project1_idx` (`Project_project_id`),
  CONSTRAINT `fk_SystemSafety_Project1` FOREIGN KEY (`Project_project_id`) REFERENCES `Project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `SystemSafety` WRITE;
/*!40000 ALTER TABLE `SystemSafety` DISABLE KEYS */;

INSERT INTO `SystemSafety` (`safety_id`, `safety_name`, `created_at`, `updated_at`, `Project_project_id`)
VALUES
	(1,'S',NULL,NULL,0),
	(2,'T',NULL,NULL,0),
	(3,'O',NULL,NULL,0),
...
/*!40000 ALTER TABLE `SystemSafety` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table TargetRiskLevels
# ------------------------------------------------------------

DROP TABLE IF EXISTS `TargetRiskLevels`;
...
CREATE TABLE `TargetRiskLevels` (
  ...
  KEY `fk_PreRiskLevels_CostMetric1_idx` (`CostMetric_cost_id`),
  KEY `fk_PreRiskLevels_ScheduleMetric1_idx` (`ScheduleMetric_schedule_id`),
  CONSTRAINT `fk_PreRiskLevels_CostMetric10` FOREIGN KEY (`CostMetric_cost_id`) REFERENCES `CostMetric` (`cost_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_PreRiskLevels_ScheduleMetric10` FOREIGN KEY (`ScheduleMetric_schedule_id`) REFERENCES `ScheduleMetric` (`schedule_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `User` (
  ...
  CONSTRAINT `fk_User_Role` FOREIGN KEY (`Role_role_id`) REFERENCES `Role` (`role_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `User` WRITE;
/*!40000 ALTER TABLE `User` DISABLE KEYS */;

INSERT INTO `User` (`user_id`, `first_name`, `last_name`, `password`, `created_at`, `updated_at`, `Role_role_id`, `email`, `username`, `parent_user_id`)
VALUES
